...
-------------------- Coffre
RegisterServerEvent('w_pharma:prendreitems')
AddEventHandler('w_pharma:prendreitems', function(itemName, count)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterNetEvent('w_pharma:stockitem')
AddEventHandler('w_pharma:stockitem', function(itemName, count)
	local _source = source
...
ESX.RegisterServerCallback('w_pharma:inventairejoueur', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('w_pharma:prendreitem', function(source, cb)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_pharmacie', function(inventory)
		cb(inventory.items)
	end)
end)
